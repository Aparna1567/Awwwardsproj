  ...
  return (
    <section className='bg-black pb-52'>
        <div className='container mx-auto px-3 md:px-10'>
            ...
            <p className='max-w-md font-circular text-blue-50 opacitt-50 text-lg'>Immense yourself in a rich and ever-expanding universe where a vibrant 
            ...
            <BentoTilt className='border border-white/20 relative mb-7 h-96 w-full overflow-hidden rounded-md md:h-[65vh]'>
                <BentoCard src="videos/feature-1.mp4" title={<>radi<b>n</b>t</>} 
             ...
             <div className="grid grid-cols-2 grid-rows-3 gap-7 h-[135vh]">
                ...
                ">
                    ...
                    title={<>zig<b>m</b>a</>}
                    description= "An Anime and gaming-inspired NFT collection - the IP pried for expansion."
                    />
                </BentoTilt>
                <BentoTilt className="bento-tilt_1 border border-white/20 relative col-span-2 row-span-1 ms-32 md:col-span-1 md:ms-0">
                ...
                <BentoTilt className="bento-tilt_1 border border-white/20 relative me-14 md:me-0 md:col-span-1 col-span-2">
                ...
                <BentoTilt className="bento-tilt_2">
                    <div className="flex size-full flex-col justify-between bg-violet-800 p-5">

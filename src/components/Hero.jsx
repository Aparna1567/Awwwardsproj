...
const Hero = () => {
  ...
  return (
    <div className="relative h-dvh w-screen overflow-x-hidden">
      ...
      {isLoading && (
        <div className="flex-center absolute h-dvh w-screen overflow-hidden bg-violet-50">
      ...
      <div id="video-frame"
          ...
          <div className="mask-clip-path absolute-center absolute z-50 size-64 cursor-pointer overflow-hidden rounded-lg">
            <div onClick={handleMiniVdClick} className="origin-center scale-50 opacity-0 transition-all duration-500 ease-in hover:scale-100 hover:opacity-100">
              <video ref={nextVideoRef} src={getVideoSrc(upcomingVideoIndex)}
                ...
                onLoadedData={handleVideoLoad} loading="lazy" />
            </div>
          </div>
        ...
        <div className="absolute left-0 top-0 z-40 size-full">
          <div className="mt-24 px-5 sm:px-10">
            ...
            <p className="mb-5 max-w-64 font-rregular text-blue-100">Enter the Metagame Layer
